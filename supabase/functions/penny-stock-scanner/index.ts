...
- Common mistakes to AVOID: using wrong exchange ticker, using a ticker that belongs to a different company, using tickers for companies that have been acquired or gone private.
...
- institutional_ownership_pct: Approximate % held by institutions (mutual funds, hedge funds, pension funds)
- institutional_following: "HEAVY" (>50%), "MODERATE" (20-50%), "LIGHT" (<20%), "MINIMAL" (<5%)
- top_institutional_holders: Name 1-3 notable institutional holders if known (e.g., "Vanguard, BlackRock, ARK Invest")
- retail_sentiment: "STRONG_BULL" (heavy retail interest, social buzz), "MODERATE" (some retail following), "UNDER_RADAR" (almost no retail awareness), "CONTRARIAN" (retail bearish but fundamentally strong)
- social_buzz_score: 0-100 (Reddit, Twitter/X, StockTwits activity level)
- analyst_coverage: "WELL_COVERED" (5+ analysts), "SPARSE" (1-4 analysts), "NONE" (zero coverage — true hidden gem)
- short_interest_pct: Approximate short interest as % of float
- insider_buying_signal: true/false — have insiders been buying in last 6 months?
...
- dilution_risk_score (higher = safer), share_stability_score, insider_ownership_pct
- shelf_registration_risk, dilution_history: "CLEAN"/"MINOR"/"WARNING"/"SERIAL_DILUTER"
...
- ticker (MUST BE VERIFIED REAL TICKER), company_name, sector, sub_sector
