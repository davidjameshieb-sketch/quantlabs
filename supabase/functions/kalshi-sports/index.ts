  ...
  try {
    ...
    const enrichedMarkets = markets.map((mkt: any) => {
      ...
      return {
        ...
        volume: Number(mkt.volume_fp ?? mkt.volume ?? 0) || 0,
        volume_24h: Number(mkt.volume_24h_fp ?? mkt.volume_24h ?? 0) || 0,
        open_interest: Number(mkt.open_interest_fp ?? mkt.open_interest ?? 0) || 0,
